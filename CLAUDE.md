...
- Class/type names: `CamelCase`, functions/variables: `lower_snake_case`, configuration constants: `UPPER_SNAKE_CASE`
- Import order: According to the lint configuration in each project
- Error handling: Use `try`/`except` with specific exceptions
- Provide descriptive error messages with traceback when appropriate

## General python style

- Use type annotations and validate typing using mypy
- Use flake8 and the corresponding configurations to lint code
